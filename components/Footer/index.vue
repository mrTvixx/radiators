<template>
  <footer class="footer">
    <div class="row">
      <span>
        Есть вопросы? Звоните ежедневно с 9
        <sup>00</sup>-20
        <sup>00</sup>
      </span>
      <a href="tel:+79996917470" class="footer__phone">+7 999 691 74 70</a>
    </div>
    <div class="row">
      ...
      <nav class="footer__menu">
        ...
        <div class="footer__menu-links">
          <router-link
            ...
            :key="item.id"
            class="footer__menu-links-element"
            :to="item.link"
          >{{item.title}}</router-link>
        </div>
      </nav>
...
<script>
import { links, catalog } from "../../constants/links";
